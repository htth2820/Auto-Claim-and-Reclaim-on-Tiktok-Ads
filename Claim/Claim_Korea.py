...
id_sheet = int(input('STT Sheet Mail: ')) - 1
...
#sheet_Mail = sheets.get_worksheet(id_sheet)
sheet_Mail = sheets.worksheet('Chuẩn hóa Mail')
list_acc = sheet_Mail.col_values(1)
print('Number of Account:', len(list_acc))
list_pwd = sheet_Mail.col_values(2)
print('Number of Password:', len(list_pwd))
list_stt = sheet_Mail.col_values(3)
print('Number of STT:', len(list_stt))
if len(list_acc) > len(list_stt):
    for i in range(len(list_stt), len(list_acc)+1):
        print(i)
        sheet_Mail.update_cell(i, 3, '.')
        sleep(0.2)
list_stt = sheet_Mail.col_values(3)
print('Number of STT:', len(list_stt))
list_acc_reg = []
...
with open('data.txt', mode='w+', encoding='utf-8') as file:
    for i in range(1,len(list_acc)):
        if list_stt[i] == '' or list_stt[i] == '.':
            if str(list_acc[i]).find('|') < 0:
                list_acc_reg.append(list_acc[i])
                list_pwd_reg.append(list_pwd[i])
                file.write(list_acc[i]+'\n'+list_pwd[i]+'\n')
            else:
                info_acc = str(list_acc[i]).split('|')
                list_acc_reg.append(info_acc[0]+'@yahoo.com')
                list_pwd_reg.append(info_acc[1])
                file.write(info_acc[0]+'@yahoo.com'+'\n'+info_acc[1]+'\n')
num_lines = sum(1 for line in open('data.txt'))
print(num_lines)
print(*list_acc_reg, sep='\n')
...
for i in range(1, 10):
    ...
    getAccount = xlsdata.get_value_excel('data.xlsx', 'ChuaReg', 'A' + str(i)).split('|')
    mailUser = getAccount[0]
    mailPass = getAccount[1]

    getInfor = xlsdata.get_value_excel('data.xlsx', 'ChuaReg', 'B' + str(i)).split('\n')
    com_name_Kor = getInfor[0]
    com_name_Eng = getInfor[7]
    com_web = getInfor[1]
    com_street = getInfor[3]

    split_addr = getInfor[4].split(', ')
    ...
    ######SDT có dấu ngoặc
    com_phone = ''.join(getInfor[8].split('-'))
    com_phone = com_phone.replace('(', '').replace(')', '')
    ...
    try:
        browser.find_element_by_xpath(
            '/html/body/div[1]/div/div[1]/div/div[7]/div/div/div/div[3]/div[5]/button').click()
    except:
        print('')
    #####Gửi mail thất bại come back gửi lại
    browser.find_element_by_xpath(
        '/html/body/div[1]/div/div[1]/div/div[2]/div/div[2]/div[1]/div[1]/div/div[2]/div/div/div[2]/div/div[1]/ul/li[3]/a').click()
    act_code = re.search(r'Here is your verification code: (.*?) It is valid within 10 minutes.',
    ...
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/div[3]/section/div[2]/main/form/div[4]/div/div/div[1]/input') \
        .send_keys(act_code)
    sleep(0.5231)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/div[3]/section/div[2]/main/form/div[5]/div[1]/div') \
        .click()
    sleep(0.5231)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/div[3]/section/div[2]/main/form/div[7]/div/button[2]') \
        .click()
    ...
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/section/form/div[1]/div[1]/div[2]/div/div[1]/input') \
        .send_keys(mailUser)
    sleep(0.8231)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/section/form/div[1]/div[2]/div[2]/div/div[1]/input') \
        .send_keys(com_phone)
    sleep(0.5)
    browser.execute_script("window.scrollTo(0,document.body.scrollHeight/4)")  # Scroll down
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/section/form/div[2]/div[1]/div[2]/label/span/span') \
        .click()
    sleep(0.31)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[1]/section/div/div/section/div[5]/div/section/form/div[3]/div/button') \
        .click()
    wait('Continue')
    ...
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[2]/div/div[1]/input') \
        .send_keys(com_name_Kor)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[3]/div/div[1]/textarea') \
        .send_keys(com_web)

    ###Select Industry
    browser.execute_script("window.scrollTo(0,document.body.scrollHeight/4)")  # Scroll down
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[4]/div[1]/div/div/div[1]/span/span/i') \
        .click()  # click to drop list
    sleep(uniform(1, 3))  # wait drop list
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[4]/div[1]/div/div/div[2]/div/div[1]/ul/li[' + str(
            randint(1, 29)) + ']/span') \
    ...
    ###Select Sub-Industry
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[4]/div[2]/div/div/div[1]/span/span/i').click()
    sleep(uniform(1, 3))
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[4]/div[2]/div/div/div[2]/div/div[1]/ul/li[' + str(
            randint(1, 3)) + ']/span').click()

    ###Fill Street
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[5]/div/div[1]/input') \
        .send_keys(com_street)
    sleep(1.1231)

    ###Select Province
    province = browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[6]/div/div/div[1]/span/span/i')
    sleep(uniform(1, 3))
    ...
    ###Select City
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[7]/div/div/div[1]/span/span/i') \
        .click()
    sleep(uniform(1, 3))
    ...
    ###Fill Next
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[2]/div[8]/div/div[1]/input') \
        .send_keys(com_zipcode)
    sleep(0.8231)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[3]/div[2]/div/div[1]/input') \
        .send_keys(com_boss)
    sleep(0.412)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[4]/div/div[3]/div/div/input') \
        .send_keys(com_ID)
    sleep(1.1)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[5]/div/div[3]/div/div[1]/input') \
        .send_keys(com_ID)
    sleep(0.9)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[5]/div/div[4]/div/div/input') \
        .send_keys(com_name_Eng)
    sleep(1.231)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[5]/div/div[5]/div/div/input') \
        .send_keys(com_phone)
    sleep(1.31)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[5]/div/div[6]/div/div/input') \
        .send_keys(com_boss)

    ###Select Picture
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[5]/div/div[7]/div/div[1]/div').click()
    sleep(1)
    ...
    ###Submit
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[7]/button').click()
    sleep(10)
    ###Verify Now
    browser.find_element_by_xpath('/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/div/i').click()
    wait('Verify Now')
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[8]/div/button').click()
    sleep(1, 123)
    browser.find_element_by_xpath(
        '/html/body/div[1]/section/div[2]/section/div/div/section/div[2]/form/div[8]/div/div[1]/span[2]').click()
    sleep(2.14124)
